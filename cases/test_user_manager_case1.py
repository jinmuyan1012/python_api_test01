...
from data.user_manager_data import UaerManagerDate
...
class TestUserManagerCase(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.new_password = um.user_case_data.get('password')
    ...
    def test02_edit(self):
        # new_user_name = 'zzbm02'
        new_password = new_user_name = 'zzbm07'
